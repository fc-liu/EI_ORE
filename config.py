...
def parse_args():
    ...
    parser.add_argument("--ckpt_name", default="all",
                        type=str, help="name of checkpoint")

    parser.add_argument("--max_sentence_length", default=386,
    ...
    parser.add_argument("--l2_reg_lambda", default=3e-6,
    ...
    parser.add_argument("--decay_rate", default=0.85,
                        type=float, help="Decay rate for learning rate (Default: 0.9)")
    parser.add_argument("--cudas", default=[0], type=int,
                        help="used cudas", nargs='+')
    parser.add_argument("--num_cls", default=10,
                        type=int, help="number of classes")
    parser.add_argument("--seed", default=1,
                        type=int, help="random seed")
    parser.add_argument("--pretrain_batch_size", default=32,
                        type=int, help="batch size of pre-training period")

    parser.add_argument("--ent_src", default="nlg", choices=['nlg', 'spo','ds'],
                        type=str, help="what dataset to use for entity ranking")

    parser.add_argument("--data_src", default="nyt", choices=['nyt','ds', 'spo'],
                        type=str, help="what dataset to evaluate")


    parser.add_argument("--is_ent", action="store_true",
                        help="whether to use entity ranking")

    parser.add_argument("--is_cxt", action="store_true",
                        help="whether to use context contrastive learning")
